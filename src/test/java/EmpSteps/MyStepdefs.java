...
import EmpUtils.TestNGListners;
...
public class MyStepdefs {
    ...
    public void creatingAEmployee() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("createEmployee");
        ...
        response = given()
                ...
                .then().body(matchesJsonSchemaInClasspath("EmployeeSchema.json")).statusCode(201).extract().response();
    }
    ...
    public void updateTheUser() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("updateEmployee");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
        ...
        response = given()
                ...
                .then().body(matchesJsonSchemaInClasspath("EmployeeSchema.json")).statusCode(200).extract().response();
    }
    ...
    public void creatingAEmployeeWithFirstNameBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeeWithfirstNameBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void creatingAEmployeeWithLastNameBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeeWithlastNameBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void creatingAEmployeeWithAddressBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeewithAdressBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void creatingAEmployeeWithPhoneNumberBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeewithphoneNumberBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void errorIsThrownWhenIDIsNotGivenWhileDeletingAEmployee() throws JsonProcessingException {
        ErrorObject errorObject1 = objectMapper.readValue(delresponse.asString(), ErrorObject.class);
        Assert.assertEquals(errorObject1.getError(), "Method Not Allowed");
    }
    ...
    public void detailsOfEmployeeDisplayedWithInvalidEndpoint() throws JsonProcessingException {
        ...
        Assert.assertEquals(errorObject.getPath(), "/swagger-ui-custom.html");
    }
    ...
    public void updatingAEmployeeWithFirstNameBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeefirstNameBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void updatingAEmployeeWithLastNameBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeelastNameBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void updatingAEmployeeWithPhoneNumberBlank() {
        JSONObject testData = (JSONObject) TestNGListners.data.get("EmployeephoneNumberBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
